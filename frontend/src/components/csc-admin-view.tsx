...
import type { CscSaveRequest, CscSnapshot } from "@/lib/types";
          ...
          <tbody>
            {rows.map((r, i) => {
              ...
              return (
                ...
                >
                  <td className="px-6 py-1.5" style={{ color: "var(--text-primary)" }}>
                    {r.product_name}
                  </td>
                  ...
                  <td className="px-6 py-1.5 text-right tabular-nums" style={{ color: "var(--text-secondary)" }}>
